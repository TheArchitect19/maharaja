            ...
            <div className='w-full p-4 flex flex-col md:w-10/12 md:p-0'>
                ...
                <div className="w-full min-h-[50vh] relative flex justify-center items-center flex-col">
                    <div className="mt-5 flex justify-between w-[90%] md:w-4/5 lg:w-[70%] ">
                        <div className="text-2xl md:text-3xl lg:text-4xl font-extrabold tracking-wider"><FaQuoteLeft /></div>
                        <div className="text-2xl md:text-3xl lg:text-4xl font-extrabold tracking-wider"><FaQuoteRight /></div>
                    </div>
                                        ...
                                        >
                                            <div className="rounded-full absolute -top-10 border-2 border-black bg-gray-300 flex justify-center items-center w-[5.5rem] h-[5.5rem]">
                                                <div className="rounded-full w-20 h-20 border-2 overflow-hidden">
                                                    <Image width={100} height={100} src={testimonial?.image} alt="dp" className='object-cover w-full h-full' onContextMenu={handleContextMenu}
                                            ...
                                            <div >
                                                <h3 className='text-[0.85rem] mt-2 md:mt-4 font-semibold md:text-lg'>Demo Name</h3>
                                            </div>
                                        </div>
                                    </SwiperSlide>
                                ))
